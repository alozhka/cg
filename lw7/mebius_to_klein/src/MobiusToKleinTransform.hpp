...
class MobiusToKleinTransform
{
public:
	MobiusToKleinTransform()
		: m_mesh(GridU, GridV)
	{
	...
	{
		const float phase = 0.5f * (1.0f - std::cos(time * MorphSpeed));
		...
		m_shader.SetUniformVec3("uColor", glm::vec3(0.35f, 0.95f, 0.55f));
